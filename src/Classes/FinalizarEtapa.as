package Classes
{
	...
	import Componentes.comFinalizarEtapa;
	...
	public class FinalizarEtapa
	{
		//private var mje:Label.t;
		public static var opcion:int;
		private var objComFinalizaEtapa:comFinalizarEtapa;
		
		public var objComNotificar:comNotificar;
		public var objTecladoAlfaNum:comTecladoAlfaNumerico;
		public  var codigo:String="";
		
		public function FinalizarEtapa(objComFinalizaEtapa:comFinalizarEtapa)
		{
			
			this.objComFinalizaEtapa = objComFinalizaEtapa;
		...
		private function finalizaSend():void{
			var parametros:Object = new Object();
			parametros.IDVehiculo = objComFinalizaEtapa.data.IDVehiculo;
			parametros.IDEtapa = objComFinalizaEtapa.data.IDEtapa;
		...
		public function finalizarEtapa2():void{
			comTecladoAlfaNumerico.opcion = 0;
